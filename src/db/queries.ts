...
export async function insertGrounnelGateEvents(
  rows: Array<{
    runId: string;
    claimId: string;
    gate: "reason_consistency" | "implicit_negation" | "reason_year" | "reason_ordinal" | "counterfact_ignored" | "contradiction_evidence" | "claim_reason_overlap" | "numeric" | "year" | "retry_reconciliation";
