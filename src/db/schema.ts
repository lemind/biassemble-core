...
export const grounnelGateEvents = grounnel.table("grounnel_gate_events", {
  ...
  gate: text("gate", { enum: ["reason_consistency", "implicit_negation", "counterfact_ignored", "contradiction_evidence", "claim_reason_overlap", "numeric", "year", "retry_reconciliation"] }).notNull(),
