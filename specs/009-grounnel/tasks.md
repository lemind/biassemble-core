...
- [x] **T008** `SearchProvider` interface + hybrid implementation (plan.md §2 step 2, D019 §2 "provider abstraction scope", D021)
  ...
  - **Verify:** `pnpm test:run tests/unit/providers/search/` — 10 tests green (5 Tavily, 5 hybrid: success path, fallback-on-all-DIY-failure, paywall heuristic, zero-candidates-falls-back-immediately, discovery retry).
